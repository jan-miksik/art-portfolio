...
export const piecesData = {
  SANS_TOPIC: [
    {
      ...
      description: '',
      image: "sans-topic/history cylinder - historie válec - geskiedenis silinder(af),2020,drawing on paper,275x100cm.jpg",
      price: 0,
    ...
    },
    {
      ...
      description: '',
      image: "sans-topic/přejmenování - تغییر نام(fa) - renaming,2020,drawing on paper,30x21cm.jpg",
      topic: Topics.SANS_TOPIC,
      price: 0,
      technique: Techniques.DRAWING,
      techniqueDescription: TechniqueDescription.DRAWING_ON_PAPER,
    ...
    },
    {
      ...
      description: '',
      image: "sans-topic/kalo(ceb) - hat - klobouk,2020,drawing on paper,30x21cm.jpg",
      topic: Topics.SANS_TOPIC,
      price: 0,
      technique: Techniques.DRAWING,
      techniqueDescription: TechniqueDescription.DRAWING_ON_PAPER,
    ...
    },
    {
      ...
      description: '',
      image: "sans-topic/neighborhood - sousedství - vicinia(la),2020,drawing on paper,30x21cm.jpg",
      topic: Topics.SANS_TOPIC,
      price: 0,
      technique: Techniques.DRAWING,
      techniqueDescription: TechniqueDescription.DRAWING_ON_PAPER,
  ...
  GEOMETRY: [
    ...
    },
    {
      ...
      description: '',
      image: "geometry/almost circles - skoro kruhy - pafupifupi zozungulira(ny),2019,drawing on paper,30x21cm.jpg",
      topic: Topics.GEOMETRY,
      price: 0,
      technique: Techniques.DRAWING,
      techniqueDescription: TechniqueDescription.DRAWING_ON_PAPER,
    ...
    },
    {
      ...
      description: '',
      image: "geometry/簡略化(jp) - zjednodušování - simplification,2019,drawing on paper,30x42cm.jpg",
      price: 0,
      topic: Topics.NODE_AVATARS,
      technique: Techniques.DRAWING,
      techniqueDescription: TechniqueDescription.DRAWING_ON_PAPER,
